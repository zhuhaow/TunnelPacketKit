...
//  TunnelPacketKit
//
//  Created by Zhuhao Wang on 16/1/19.
...
class Checksum {
    ...
    static func computeChecksumUnfold(data: NSData, from start: Int = 0, var to end: Int? = nil, withPseudoHeaderChecksum initChecksum: UInt32 = 0) -> UInt32 {
